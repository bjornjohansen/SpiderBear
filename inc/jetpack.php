 ...
 */
function spiderbear_jetpack_setup() {
...
add_action( 'after_setup_theme', 'spiderbear_jetpack_setup' );
 ...
 */
function spiderbear_social_menu() {
 ...
 */
function spiderbear_author_bio() {
 ...
 */
function spiderbear_author_bio_avatar_size() {
	return 140;
}
add_filter( 'jetpack_author_bio_avatar_size', 'spiderbear_author_bio_avatar_size' );

/**
 * Show/Hide Featured Image outside of the loop.
 */
function spiderbear_jetpack_featured_image_display() {
 ...
 */
function spiderbear_has_post_thumbnail( $post = null ) {
 ...
 */
function spiderbear_get_attachment_image_src( $post_id, $post_thumbnail_id, $size ) {
